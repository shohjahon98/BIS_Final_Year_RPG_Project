...
public class MyJoystick : MonoBehaviour {
	...
	void Start()
	{
		...
		gui = transform.GetComponent<GUITexture>();
			...
			for(int i = 0;i < count; i++)
			{
				...
				{	
					...
					{					
						...
						Rect tempPI = gui.pixelInset;
						tempPI.x =  Mathf.Clamp( guiTouchPos.x, guiBoundary.min.x, guiBoundary.max.x );
						tempPI.y =  Mathf.Clamp( guiTouchPos.y, guiBoundary.min.y, guiBoundary.max.y );		
						gui.pixelInset = tempPI;
					}
